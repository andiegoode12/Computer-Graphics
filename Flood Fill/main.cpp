...
void floodFill4 (int x, int y, Color fillColor, Color interiorColor)
{
    ...
    color = getPixel (x, y);
    if (colorsEqual(color, interiorColor)) {
...
void displayFcn (void){
    ...
    floodFill4(winWidth/2, winHeight-75, Color(1.0f,0.0f,0.0f), Color(1.0f,1.0f,1.0f));
    glColor3f(1.0, 0.0, 0.0);
    ellipseMidpoint(winWidth/2 + 115, winHeight-75, 50, 40);
    floodFill4(winWidth/2 + 115, winHeight-75, Color(1.0f,1.0f,0.0f), Color(1.0f,1.0f,1.0f));
    glColor3f(0.0, 0.0, 1.0);
    ellipseMidpoint(winWidth/2 - 115, winHeight-75, 50, 40);
    floodFill4(winWidth/2 - 115, winHeight-75, Color(0.0f,0.0f,0.0f), Color(1.0f,1.0f,1.0f));
    glColor3f(0.0, 1.0, 0.0);
    ellipseMidpoint(winWidth/2 + 60, winHeight-125, 50, 40);
    floodFill4(winWidth/2 + 60, winHeight-125, Color(0.0f,0.0f,1.0f), Color(1.0f,1.0f,1.0f));
    glColor3f(1.0, 1.0, 0.0);
    ellipseMidpoint(winWidth/2 - 60, winHeight-125, 50, 40);
    floodFill4(winWidth/2 - 60, winHeight-125, Color(0.0f,1.0f,0.0f), Color(1.0f,1.0f,1.0f));
    glFlush ( );
}
